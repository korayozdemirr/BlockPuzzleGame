# Unity Architecture & Project Rules
...
3. **UI Standard:** Always use TextMeshPro (`TextMeshProUGUI`). Canvas Render Mode must stay `Screen Space - Overlay` with `Scale With Screen Size (Match 0.5)`. Use `LilitaOne-Regular SDF` casual game font.
